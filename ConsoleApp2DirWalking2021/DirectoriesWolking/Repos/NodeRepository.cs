...
namespace DirectoryNavigator
{
	public class NodeRepository : INodeRepository
	{
		...
		{
			_dirs.Add(new Dir { id = 1, name = "Novokuz", owner_id = 0, type = NType.dir });
			...
			_dirs.Add(new Dir { id = 2, name = "English", owner_id = 0, type = NType.dir });
			...
			_dirs.Add(new Dir { id = 240, name = "Task1", owner_id = 24, type = NType.task });
			_dirs.Add(new Dir { id = 241, name = "Task2", owner_id = 24, type = NType.task });

			_dirs.Add(new Dir { id = 242, name = "Task1000", owner_id = 22, type = NType.task });
			_dirs.Add(new Dir { id = 243, name = "Task2000", owner_id = 22, type = NType.task });
			_dirs.Add(new Dir { id = 244, name = "XIG_ARTICLE", owner_id = 22, type = NType.dir });
		}
