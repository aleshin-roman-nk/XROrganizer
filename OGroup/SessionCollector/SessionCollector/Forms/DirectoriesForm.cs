...
namespace SessionCollector.Forms
{
	public partial class DirectoriesForm : Form, IDirectoriesView
	{
		...
		public ViewResult<INode> Result { get; private set; }
		...
		public void DisplayNodes(IEnumerable<INode> lst, INode d = null)
		{
			bs.DataSource = null;
			bs.DataSource = lst;
		...
		public ViewResult<INode> Go()
		{
			ViewResult<INode> res = new ViewResult<INode>();
