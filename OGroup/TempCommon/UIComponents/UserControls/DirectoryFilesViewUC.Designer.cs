...
{
	partial class DirectoryFilesViewUC
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.itemsGrid.RowTemplate.DividerHeight = 5;
			this.itemsGrid.RowTemplate.Height = 86;
			...
			this.Name = "DirectoryFilesViewUC";
